...
using SupportSectionModelBinder = Sitecore.Support.Forms.Mvc.Controllers.ModelBinders.SectionModelBinder;
...
namespace Sitecore.Support.Forms.Mvc.Pipelines.Initialize
{
    public class AddCustomMetadataProvider
    {
        ...
        public virtual void Process(PipelineArgs args)
        {
            ...
            ModelBinders.Binders.Add(typeof(SectionViewModel), new SupportSectionModelBinder());
